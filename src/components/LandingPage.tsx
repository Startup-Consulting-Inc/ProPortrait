...
function HeroSlider() {
  ...
  useEffect(() => {
    ...
    const animate = (ts: number) => {
      ...
      // ease in-out sine sweep 42 → 72 → 42
  ...
  return (
    ...
    >
      ...
      {/* After — AI portrait, revealed from left */}
      <div
      ...
      {/* Handle */}
      <div
        className="absolute top-1/2 z-20 -translate-y-1/2 w-11 h-11 bg-white rounded-full shadow-2xl flex items-center justify-center pointer-events-none transition-transform"
...
export default function LandingPage({ onSignIn }: LandingPageProps) {
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-slate-900 flex flex-col">
      ...
      {/* Hero */}
      <main className="flex-1 flex flex-col items-center justify-center px-6 py-10 max-w-6xl mx-auto w-full">
        ...
        {/* Feature strip */}
        <div className="mt-20 w-full grid grid-cols-1 sm:grid-cols-3 gap-6">
          {[
            {
              icon: (
            ...
            {
              icon: (
                <svg className="w-6 h-6 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>
              ),
